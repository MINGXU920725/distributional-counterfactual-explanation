...
| `HELOC/` / `cardio/` / `market/` | Independent experiment directories for each dataset:<br>• Contains experiment running scripts (e.g., `cardio.py`) responsible for transferring data/models to GPU<br>• Stores experiment result files (e.g., `.xlsx`) |
